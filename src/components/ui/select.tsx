...
const Select = React.forwardRef<HTMLSelectElement, SelectProps>(
  ({ className, onValueChange, onChange, children, placeholder, ...props }, ref) => {
      ...
      <div className="relative">
        <select
          className={cn(
            ...
            "bg-background/50 backdrop-blur-sm border-border/40 hover:border-border/60 focus:border-primary/50 transition-colors",
            className
          )}
          ref={ref}
