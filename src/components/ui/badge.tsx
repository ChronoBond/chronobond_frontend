  ...
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-semantic-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outline: "text-semantic-text border-semantic-border",
        success:
        ...
        error:
          "border-transparent bg-error/10 text-error border-error/20 hover:bg-error/20",
        info:
          "border-transparent bg-brand-500/10 text-brand-500 border-brand-500/20 hover:bg-brand-500/20",
      },
    },
    defaultVariants: {
      variant: "default",
